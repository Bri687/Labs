...
//print("The value of foo is \(foo)")
//You’ll get a compiler error if you uncomment line 10 because of variable scope.
...
// X lives outside the loop, so both inside and after the loop can use it.  Foo was made inside the loop, so it disappeared when the loop ended.

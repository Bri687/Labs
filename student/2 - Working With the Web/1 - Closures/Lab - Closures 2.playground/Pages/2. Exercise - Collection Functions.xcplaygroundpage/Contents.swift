...
let names = ["Whitley", "Kaden", "Nathan", "Logan", "Ellie"]
let sortedCollection1 = names.sorted(by: forwards)

print("Sorted names: \(sortedCollection1)")
...
print("Sorted names (closure): \(sortedCollection2)")
...
print("Sorted names (short closure): \(sortedCollection3)")
/*:

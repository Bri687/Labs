...
let runningChallenges: [String] = [
    "Run 5 times a week",
    "Complete a 10k run this month"
]
let calisthenicsChallenges: [String] = [
    "Do 50 push-ups a day",
    "Hold a plank for 2 minutes"
]
let weightliftingChallenges: [String] = [
    "Lift weights 3 times a week",
    "Increase bench press by 20 lbs in 1 month"
]

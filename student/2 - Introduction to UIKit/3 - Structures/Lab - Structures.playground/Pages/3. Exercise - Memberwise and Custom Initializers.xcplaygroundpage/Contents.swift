...
print("My favorite book is \(favoriteBook.title) by \(favoriteBook.author).  It only has \(favoriteBook.pages) pages and costs $\(favoriteBook.price) on Books.")
/*:
...
var currentLaptop = Laptop(
    yearPurchased: 2019
)
var previousLaptop = Laptop(
    screenSize: 13,
    repairCount: 3,
    yearPurchased: 2015
)
